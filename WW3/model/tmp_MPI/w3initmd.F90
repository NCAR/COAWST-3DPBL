...
!/
      ...
      CHARACTER(LEN=512), PARAMETER  :: SWITCHES  = &
                    'F90 NOGRB NC4 DIST MPI PR3 UQ FLX0 LN1 ST4 STAB0 NL1 BT1 DB1 MLIM TR0 BS0 IC0 IS0 REF0 XX0 WNT1 WNX1' // &
                    ' CRT1 CRX1 TRKNC COAWST O0 O1 O2 O3 O4 O5 O6 O7 O11 O14' // &
                    ''
!/
      CONTAINS
!/ ------------------------------------------------------------------- /
