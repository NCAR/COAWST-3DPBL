...
export   MY_ROOT_DIR=/projects/oracle/erichend/COAWST-BRANKO-3DPBL
export   MY_PROJECT_DIR=${MY_ROOT_DIR}
#  BK 08/10/2023  insert these here for portability
...
# MKL
export       MKL_LIBDIR=/nopt/nrel/apps/compilers/intel/2020.1.217/mkl/lib/intel64
...
#  export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/ROMS/Functionals
   export     MY_HEADER_DIR=${MY_PROJECT_DIR}/Projects/Test_WW3_WRF
   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Projects/Test_WW3_WRF
